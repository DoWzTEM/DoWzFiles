...
if DevAli:get(DoWz.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(DoWz.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(DoWz.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DoWzName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DoWzName then 
DoWzNames = DevAli:smembers(DoWz.."Ali:Mute:Names"..msg.chat_id_) or ""
if DoWzNames and DoWzNames[1] then 
for i=1,#DoWzNames do 
if DoWzName:match("(.*)("..DoWzNames[i]..")(.*)") then 
...
DevAli:set(DoWz.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(DoWz.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
